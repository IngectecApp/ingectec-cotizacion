        ...
        def abrir_modal_historial(e):
            ...
            if db:
                ...
                for row in filas:
                    ...
                    resultados_hist.controls.append(ft.ListTile(title=ft.Text(f"N° {nro} - {cli}{etiqueta_creador}", color="#fbbf24", weight="bold"), subtitle=ft.Text(f"Fecha: {fec} | Total: ${int(float(tot)):,}"), on_click=cargar_historial))
                db.close()
